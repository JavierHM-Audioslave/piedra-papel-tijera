...
const Footer = () => {
    ...
    const topMeasure = document.querySelector("#papel") ? "10em" : document.querySelector("#tijera") ? "10em" : document.querySelector("#piedra") ? "10em" : "13.4em";
        ...
        <Container id="footer" style={{ position: "relative", top: "11em" }}>
            <Row>
                <Col className="d-flex justify-content-center justify-content-lg-end mb-3">
                    ...
                    <Button variant="outline-light" className="px-5 py-2" onClick={() => setShowModal(true)}>
                        RULES
                    </Button>

                    <Modal show={showModal} fullscreen="md-down" onHide={() => setShowModal(false)} centered>
